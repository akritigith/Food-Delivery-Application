...
//     );
//      if (!response.data) {
//       // If no cart returned, return an empty cart structure
//       return { carts: [], totalCartAmount: 0 };
//     }
...
//                 Checkout
//               </button>
//                         <RazorpayButton amount={cartAmount} orderDetails={carts} />
  ...
  return (
    <div className="mt-3">
      ...
      >
        ...
        <div className="card-footer custom-bg d-flex justify-content-between align-items-center">
