...
const AdminHeader = () => {
  ...
  return (
    <ul className="navbar-nav ms-auto mb-2 mb-lg-0 me-5">
      <li key="register-admin" className="nav-item">
        <Link
      ...
      <li key="all-restaurants" className="nav-item">
        <Link
      ...
      <li key="all-deliveries" className="nav-item">
        <Link
      ...
      <li key="view-customers" className="nav-item">
        <Link
